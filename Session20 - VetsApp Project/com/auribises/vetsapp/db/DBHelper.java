...
public class DBHelper {
	...
	public Pet fetchPets(String sql) {
		...
		try {
			...
			while(set.next()) {
				pet.pid = set.getInt("pid");
				pet.name = set.getString("name");
				pet.breed = set.getString("breed");
				pet.gender = set.getString("gender");
				pet.age = set.getInt("age");
				pet.oid = set.getInt("oid");
				pet.createdOn = set.getString("createdOn");
	...
	public Consultation fetchConsultations(String sql) {
		...
		try {
			...
			while(set.next()) {
				consultation.cid = set.getInt("cid");
				consultation.issues = set.getString("issues");
				consultation.medicines = set.getString("medicines");
				consultation.weight = set.getInt("weight");
				consultation.temperature = set.getFloat("temperature");
				consultation.pid = set.getInt("pid");
				consultation.oid = set.getInt("oid");
				consultation.createdOn = set.getString("createdOn");
